...
```hrd_type``` tells us if the sample has BRCA1-type HRD or BRCA2-type HRD.
...
for very large vcfs! In these cases you may need to do some pre-process
```{r message=FALSE, warning=FALSE}
...
Please refer back to the previous section of the tutorial for interpreting CHORD's output.
