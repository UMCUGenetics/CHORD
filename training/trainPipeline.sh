...
base_dir=/hpc/cog_bioinf/cuppen/project_data/Luan_projects/CHORDv2/training/
...
#training_data_path=$base_dir/scripts/train_rf/training_data.txt.gz
#out_dir=$base_dir/models/2.00_expandedIndels/
...
trainOneModel () {
	...
	r_doCvSelSamples=$base_dir/scripts/train_rf/doCvSelSamples.R
	r_trainFinalOnWhitelist=$base_dir/scripts/train_rf/trainFinalOnWhitelist.R
...
#========= Do outer CV =========#
r_spawnOuterCvData=$base_dir/scripts/train_rf/spawnOuterCvData.R
